...
from agents.navigation.custom_local_planner import LocalPlanner
...
class CustomAgent(object):
    ...
    def __init__(self, vehicle,vehicle_pre,world_sensor, target_speed=40, opt_dict={}):
        """
        ...
        self._local_planner = LocalPlanner(self._vehicle,self._vehicle_pre,self._world_sensor, opt_dict=opt_dict)
    ...
    def _vehicle_obstacle_detected(self, vehicle_list=None, max_distance=None, up_angle_th=90, low_angle_th=0, lane_offset=0):
        ...
        # loop throug all vehicle in the world
