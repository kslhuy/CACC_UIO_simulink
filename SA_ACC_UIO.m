...
%      usync(i) = h*k1*k2*mu(i)-k2*xf(2,i)-(k1+h*k1*k2)*(psi(3,i))+...
%          k3/h*psi(2,i)+k2/h*psi(1,i)-k2/h*(Li-li)-(k1+h*k1*k2)*sat(ksi_hat(4,i),50);
%     usync(i) = h*k1*k2*mu(i)-k2*xf(2,i)-(k1+h*k1*k2)*(xp(3,i)-xf(3,i))+...
%         k3/h*(xp(2,i)-xf(2,i))+k2/h*(xp(1,i)-xf(1,i)-li)-k2/h*(Li-li)-(k1+h*k1*k2)*sat(ksi_hat(4,i),20,-20);
%      
%     usync = h*k1*k2*mu-(k1+h*k1*k2)*fc_hat-k2*x2-(k1+h*k1*k2)*(psi3)...
%         +k3/h*(psi2)+k2/h*(psi1)-k2/h*(Li-li);
